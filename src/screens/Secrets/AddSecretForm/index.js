...
import { addSecret, getListProjects } from '../../../services/api';

const AddSecretForm = ({ onClose }) => {
  ...
  const handleSubmit = async (data) => {
    return addSecretMutation.mutate(data);
  };
          ...
          <Decentralization permissions={['user-update', 'user-create']}>
            <div>
              <AsyncButton
                ...
                value="Save"
                notMaxWidth
                loading={addSecretMutation.isLoading}
              />
            </div>
          </Decentralization>
        </div>
