...
import useSortInstagram from './useSortInstagram';
...
const Table = ({ className, setStatistics, setVideoCount }) => {
  ...
  // Handle sort
  const { summaryField, displayIcon, handleSort } = useSortInstagram();
